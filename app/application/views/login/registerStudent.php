...
<!--top banner-->
	<div id="topBanner" class="blockElement">
    	<div id="topBanner_text">Student Registeration</div>
    </div>
<!--top banner ends-->
...
<div id="loginBox">
    ...
    <form name="regForm" action="performStudentRegistration" method="post">
      <fieldset>
        ...
        <dl id="fieldset_dl">
          ...
          <dt>
            <label id="roll_number"><br>
            Roll Number:</label>
          </dt>
          <dd>
            <input type="number" name="rollnum" size="30" tabindex="8" title="The Roll number should be 10 digits long"/>
          </dd>
          ...
          <dd>
            <input type="number" name="regnum" size="30" tabindex="9" title="The Registration number should be 10 digits long"/>
          </dd>
          ...
          <dd>
			...
			<dt>
            <label id="currentyear"><br>
            Current Year:</label>
          </dt>
          <dd>
            <input type="number" tabindex="15" name="currentyear" required pattern="[0-9]{1}" min="1" title="Enter a valid number for your year at this college"/>
          </dd>          
          ...
          <dd>
            <input type="number" tabindex="15" name="batch" required pattern="[0-9]{4}" title="Enter a valid year"/>
          </dd>
          ...
          <dd>
            <select name="department" tabindex="16">
         ...
         <dd>
            <select name="subject1" tabindex="17">
            	 <option value="sadf">Graph Theory</option>
                <option value="asdf">discrete mathematics</option>
                <option value="wer">Electrical Engineering</option>
                <option value="xcv">Mechanical Engineering</option>
                <option value="hjkuy">Information Technology</option>
            </select>
            ...
            <select name="subject6" tabindex="22">
            	 <option value="">Graph Theory</option>
                <option value="">discrete mathematics</option>
                <option value="">Electrical Engineering</option>
                <option value="">Mechanical Engineering</option>
            ...
            <select name="subject7" tabindex="23">
            	 <option value="">Graph Theory</option>
                <option value="">discrete mathematics</option>
                <option value="">Electrical Engineering</option>
                <option value="">Mechanical Engineering</option>
        ...
        <div id="Register_Buttons">
        		<input class="form_buttons" type="reset" value="Reset"  tabindex="25">
           	<input class="form_buttons" type="submit" value="Save"  tabindex="24">
	      </div>
      </fieldset>
    </form>
</div>
